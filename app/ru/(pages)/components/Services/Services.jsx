...
const Services = ({ dictionary, goToContact }) => {
    ...
    const data = [
        {
            value: 'Промышленные объекты',
            img: img1,
            contant: {
                title: 'Строительство промышленных объектов',
                text: 'Мы обеспечиваем постройку любых зданий из сборных конструкций с нулевого цикла в сжатые сроки: ангары, склады, холодильные помещения, фруктохранилища, заводы, фабрики и цеха.'
            }
        },
        {
